...
public class ErrorSubscribeController {
    ...
    public String subscribe(
            ...
            @RequestParam(value="ratio", defaultValue = "5") Integer ratio,
...
//        }
        ...
        ErrorSubscribeThread subscribeThread = new ErrorSubscribeThread(url, username, password, database, timeseries, columns, starttime, TYPE, percent, alpha, ratio, subId, 0, "iotdb", batchlimit);
        subscribeThread.start();
